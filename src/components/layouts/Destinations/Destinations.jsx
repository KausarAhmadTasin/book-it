const Destinations = () => {
  return (
    <div className="">
      ...
      <div>
        <div>
        <div class="flex flex-col items-start p-6 bg-white  rounded-lg  max-w-sm">
        <span class="text-sm font-bold uppercase text-red-500 tracking-wider mb-2">Destination List</span>
        ...
        <button class="px-4 py-2 bg-gray-800 text-white text-sm font-semibold rounded hover:bg-gray-700 transition duration-200">
          Discover More
        </button>
      </div>
        </div>
