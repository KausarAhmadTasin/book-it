...
const Destinations = () => {
  const destinations = [
    {
      ...
      tours: "7 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/cqnwrpg1edw0duk5yd57.jpg",
    },
    {
      id: 2,
      name: "England",
      tours: "10 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/ywmsejnanywpdwmommze.jpg",
    },
    {
      id: 3,
      name: "Sweden",
      tours: "12 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/zj7km4amjxqvyzcwyvzl.jpg",
    },
    {
      id: 4,
      name: "Dubai",
      tours: "7 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/beft53oriboiwbsvpxxz.jpg",
    },
    {
      id: 5,
      name: "India",
      tours: "15 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/uzyhpja36wphu6ohi8iv.jpg",
    },
    {
      id: 6,
      name: "France",
      tours: "9 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/qnseqqkebhcl1jshphda.jpg",
    },
    {
      id: 7,
      name: "Japan",
      tours: "8 TOURS",
      image:
        "https://res.cloudinary.com/dvubt5hiv/image/upload/v1732645531/zapvjhje7offkggctrlx.jpg",
    },
  ];
  ...
  return (
    <div className="">
      <h1 className="text-center lg:text-5xl text-xl font-semibold ">
        Destinations Nearby
      </h1>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
          ...
          <div className="lg:w-1/2 space-y-4 text-center lg:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold">
              ...
              <span className="text-[#083246]">Tevlo Agency</span>
            </h2>
            ...
            <ul className="space-y-2">
              <li className="flex items-center gap-2 md:justify-center lg:justify-start">
                <span className="text-[#083246]">✔</span> Many variations of
              ...
              <li className="flex items-center gap-2 md:justify-center lg:justify-start">
                <span className="text-[#083246]">✔</span> Expert Many variations
                Teacher Lorem
              </li>
            </ul>
      ...
      <div className="flex items-center flex-col md:flex-row">
        <div className="w-full md:w-1/2 lg:-ml-36  px-4 mb-8 md:mb-0">
          <div className="flex flex-col items-start p-6 bg-white rounded-lg max-w-sm mx-auto">
            <span className="text-sm font-bold uppercase text-[#083246] tracking-wider mb-2">
              Destination List
            </span>
